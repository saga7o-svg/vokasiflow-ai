-- Migration: 20260827134500_perfect_admin_create_user.sql
-- Description: Flawless admin_create_user RPC matching Supabase GoTrue schema and security definer
...
BEGIN
  ...
  IF target_uid IS NULL THEN
    ...
    INSERT INTO auth.users (
      ...
      clean_email,
      extensions.crypt(target_password, extensions.gen_salt('bf', 6)),
      now(),
      now(),
  ...
  ELSE
    ...
    UPDATE auth.users
       SET encrypted_password = extensions.crypt(target_password, extensions.gen_salt('bf', 6)),
